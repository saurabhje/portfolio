...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article
      className="hover-surface hover-elevate"
      style={{
    ...
    >
      ...
      {/* Links */}
      <div style={{ display: "flex", gap: "1rem", paddingTop: "0.25rem", borderTop: "1px solid var(--border-light)" }}>
        {project.github && (
          <Link
            href={project.github}
            target="_blank"
